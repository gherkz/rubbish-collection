...
SOCIAL_AUTH_PIPELINE = (
    ...
    "rubbish_collection_project.pipelines.enforce_hosted_domain",
...
#: Root URL patterns
ROOT_URLCONF = "rubbish_collection_project.urls"
...
#: WSGI
WSGI_APPLICATION = "rubbish_collection_project.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "rubbish-collection API",
    "VERSION": "1.0.0",
