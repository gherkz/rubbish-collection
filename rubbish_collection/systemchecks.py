"""
The :py:mod:`rubbish_collection` application ships with some custom system
checks which ensure that required settings are present. These system checks are registered by
the :py:class:`~rubbish_collection.apps.Config` class's
:py:meth:`~rubbish_collection.apps.AssetsConfig.ready` method.
        ...
        if value is None or value == "":
            errors.append(
                Error(
                    ...
                    id="rubbish_collection.E{:03d}".format(idx + 1),
